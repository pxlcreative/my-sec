...
from sqlalchemy import BigInteger, Boolean, ForeignKey, Index, Integer, Text, UniqueConstraint, func
...
class PlatformDefinition(Base):
    ...
    save_brochures: Mapped[bool] = mapped_column(Boolean, nullable=False, server_default="false")
